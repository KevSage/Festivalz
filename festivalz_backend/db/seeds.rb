...
Artist.create(name: "Kanye West", image: "https://www.billboard.com/files/media/02-kanye-west-performance-june-2016-billboard-1548.jpg", bio: Faker::Lorem.paragraph(sentence_count: 20), genre: "Hip-Hop", spotify:'https://open.spotify.com/embed/album/5K4W6rqBFWDnAN6FQUkS6x')
...
Artist.create(name: "Meek Mill", image: "https://www.billboard.com/files/media/meek-mill-live-performance-july-2016-billboard-1548.jpg", bio: Faker::Lorem.paragraph(sentence_count: 20), genre: "Hip-Hop", spotify:'https://open.spotify.com/embed/artist/20sxb77xiYeusSH8cVdatc')
...
Artist.create(name: "Bad Bunny", image: "https://www.billboard.com/files/media/bad-bunny-calibash-1-20-2018-billboard-1548.jpg", bio: Faker::Lorem.paragraph(sentence_count: 20), genre: "Hip-Hop", spotify:'https://open.spotify.com/embed/artist/4q3ewBCX7sLwd24euuV69X')
...
Artist.create(name: "Swae Lee", image: "https://www.billboard.com/files/media/swae-lee-wireless-fest-2018-live-b-billboard-1548.jpg", bio: Faker::Lorem.paragraph(sentence_count: 20), genre: "Hip-Hop", spotify:'https://open.spotify.com/embed/artist/1zNqQNIdeOUZHb8zbZRFMX')
